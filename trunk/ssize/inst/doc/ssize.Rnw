...
\begin{quote}
  ...
  Experiments, Technical Report, Department of Biostatisticsa and
...
<<fig=TRUE,width=12,height=12>>=
     ...
     hist(exp.sd,n=20, col="cyan", border="blue", main="", xlab=xlab)
     dens <- density(exp.sd)
