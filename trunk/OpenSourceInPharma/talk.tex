...
\abstract{
  ...
  support of ``omics'' technologies in a discovery setting. While it
  is relatively straightforward to employ open-source tools for
  basic research activities within discovery, software used in any
  regulatory context must meet more rigorous requirements for
  documentation, training, software life-cycle management, and
  technical support.
  ...
  statistician, show some example areas in which it may be used, and
  then discuss the documentation, training, and support required for
  this class of use.
