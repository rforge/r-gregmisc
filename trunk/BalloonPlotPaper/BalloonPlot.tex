...
with some observations on the ballooonplot relative to the
...
these researchers is the \code{mosaic plot} \cite{Snee.1974}.
...
\bibitem{Snee.1974} ``Graphical display of two-way contingency tables'' Snee, R.D.
  (1974) \textit{ The American Statistician}, 28, 9-12.

\bibitem{Hartigan.Kleiner.1981} ``Mosaics for contingency tables'' J.A.Hartigan and B.
