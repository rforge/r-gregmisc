...
\title{
  ...
  {Synergistic} Combination of Deterministic Mathematical
...
%% Context
\section{What is the {context}?  Medical research}
...
\frame{
  ...
  \item[Metabolites] Past: 1-20:  Present: 50-500, Future: ??
  \end{description}
}
...
\section{What is the {problem}? Modeling complex biological systems}
