...
#    temp3 <- temp3/10
    ...
    par(new=T)
    plot(temp2[,1],temp2[,2],type='l',log="x",ylim=c(5000,ymax),xlim=c(1,10^7),lty=2,xlab="",ylab="")
    par(new=T)
    plot(temp3[,1],temp3[,2],type='l',log="x",ylim=c(5000,ymax),xlim=c(1,10^7),lty=3,xlab="",ylab="")
    legend(10^4.5,ymax,c("1-comp","all-comp","NKC"),lty=1:3)
}
