...
\centering
\includegraphics[width=\textwidth]{../figures/logDataColOrd}
...
\begin{minipage}[t]{2.5in}
\centering
\includegraphics[width=\textwidth]{../figures/logDataColOrdNo}
...
%% Two figures corresponding to the row/column dendrograms - log data
\begin{figure*}[p]

\begin{minipage}[t]{2.5in}
\begin{center}
\includegraphics[width=\textwidth]{../figures/logDataRowDendrogram}
...
\begin{minipage}[t]{2.5in}
\begin{center}
\includegraphics[width=\textwidth]{../figures/logDataColDendrogram}
...
\begin{minipage}[t]{2.5in}
\centering
\includegraphics[width=\textwidth]{../figures/rowSeparator}
...
\begin{minipage}[t]{2.5in}
\centering
\includegraphics[width=\textwidth]{../figures/colSeparator}
...
%%\centering
%%\subfloat[]
%%{\includegraphics[width=\textwidth]{../figures/logData}
%%\label{test}
%%}
%%\subfloat[]
%%{\includegraphics[width=\textwidth]{../figures/origScale}
%%\label{test2}
%%}
...
\begin{minipage}[t]{2.5in}
\centering
\includegraphics[width=\textwidth]{../figures/ordinal}
