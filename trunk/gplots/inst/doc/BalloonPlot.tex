...
previously developed \code{mosaic plot}.
...
researchers is the \code{mosaic plot} (Snee 1974).

We have previously experimented with mosaic plots.  Unfortunately,
we have found that they do not lend themselves to rapid
ascertainment of trends by untrained users.  Even trained users find
...
\bibitem[contingency]{Graphical display of two-way contingency tables}
Snee, R.D. (1974) \textit{ The American Statistician},  28, 9-12.
\end{thebibiography}{99}

\bibitem[Mosaics]{Mosaics for contingency tables}
...
\bibitem[Friendly] {Graphical Methods for Categorical Data}
Friendly, M. (1992) \textit{Proceedings of SAS SUGI 17 Conference}

\bibitem[Friendly] {Mosaic displays for multi-way contingency
tables}. Friendly, M. (1991),   \textit{York Univ.: Dept. of Psychology
Reports}, No. 195.
