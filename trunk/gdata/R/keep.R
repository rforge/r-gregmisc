...
###                                                                          
### Args:     ... are objects to be kept, specified one by one, quoted or
###           unquoted list is a string vector of object names to be kept
###           sure is whether to perform the removal, otherwise return names
###           of objects that would have been removed                        
###                                                                          
### Notes:    Implemented with a few safety caps: all=T is not supported and
###           sure=T is required to perform the removal                      
###                                                                          
