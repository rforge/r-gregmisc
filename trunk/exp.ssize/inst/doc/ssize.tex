...
An R package, \texttt{ssize}, implementing the described methods, is
available from the Bioconductor project web site at
\url{http://www.bioconductor.org}.  In addition, the \texttt{ssize.sim},
which includes all of the code for the described simulation is
